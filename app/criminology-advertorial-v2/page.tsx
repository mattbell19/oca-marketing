...
const trackLeadSubmission = (formTitle: string) => {
  ...
  trackingWindow.dataLayer.push({
    event: 'generate_lead',
    lead_type: 'criminology_advertorial_info_pack_v2',
  ...
  trackingWindow.fbq?.('track', 'Lead', {
    ...
    content_category: 'Criminology Advertorial Info Pack V2'
  })
}
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F5] text-[#1d3b56] font-sans selection:bg-[#a6d5c7] selection:text-[#1d3b56] overflow-x-clip pb-16">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-10 md:pt-16">
        ...
        {/* Sub-headline */}
        <p className="text-lg md:text-2xl font-serif italic text-gray-600 text-center leading-relaxed max-w-2xl mx-auto mb-6">
          True crime tells the story. Criminology examines the behaviour, systems and decisions behind it.
        </p>

        {/* Blog Post Author and Metadata Section */}
        <div className="flex items-center justify-center gap-3 border-y border-gray-250/60 py-3 mb-8 max-w-xl mx-auto text-xs text-gray-500 font-bold">
          <div className="w-8 h-8 rounded-full bg-[#1d3b56]/10 flex items-center justify-center text-[#1d3b56]">
            <User className="w-4 h-4" />
          </div>
          <div className="flex flex-wrap items-center gap-1.5">
            <span>By <strong className="text-[#1d3b56]">OCA Editorial Team</strong></span>
            <span className="text-gray-300">•</span>
            <span>July 2026</span>
            <span className="text-gray-300">•</span>
            <span className="flex items-center gap-1"><Clock className="w-3.5 h-3.5 text-[#f38669]" /> 4 min read</span>
          </div>
        </div>

        {/* Opening paragraph immediately beneath metadata */}
        ...
        <div className="space-y-8 text-base md:text-lg leading-relaxed text-[#1d3b56]/90 font-medium">
          ...
          {/* Section 1: Criminology is about more than crime scenes */}
          <div>
          ...
          {/* Section 2: Why combine criminology with psychology? */}
          <div>
            <h2 className="text-2xl md:text-3xl font-serif font-black text-[#1d3b56] mb-4">
          ...
          <div className="border-y border-gray-200 py-8 my-8 text-center max-w-2xl mx-auto">
            ...
            <p className="text-xl md:text-2xl font-serif italic text-[#1d3b56] leading-relaxed">
              Understanding motivation, personality, social influence and mental health can help learners examine the human factors behind offending.
            </p>
          </div>

          {/* Section 3: A practical way to test a new direction */}
          <div>
            <h2 className="text-2xl md:text-3xl font-serif font-black text-[#1d3b56] mb-4">
          ...
          {/* Section 5: Designed to work around an existing life */}
          <div>
            <h2 className="text-2xl md:text-3xl font-serif font-black text-[#1d3b56] mb-4">
