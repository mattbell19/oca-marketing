...
const COURSE_DATA: Record<string, CourseConfig> = {
  ...
  'event-management-bundle': {
    ...
    upfrontPrice: '$1,299',
    fullUpfrontPrice: '$1,845',
    weeklyPrice: '$15',
    weeklyPaymentCount: 123,
    afterpayPrice: '$324.75',
    checkoutUpfront: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=1479',
    checkoutWeekly: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=1479&paymenttype=debitsuccess',
    checkoutAfterpay: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=1479&paymenttype=afterpay',
    tagCapsules: ['Events', 'Management', 'CPD Endorsed'],
    heroImage: '/oca-assets/event-confidence.jpg'
  },
  'event-management': {
    name: 'Event Management Course Bundle',
    infoPackUrl: 'https://bit.ly/3GImT6G',
  ...
  'dog-grooming': {
    name: 'Dog Grooming Advanced Course',
    infoPackUrl: 'https://ocaedu.au/courseguide-doggroom',
    upfrontPrice: '$990',
    fullUpfrontPrice: '$1,490',
    weeklyPrice: '$15',
    afterpayPrice: '$247.50',
    checkoutUpfront: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=4539',
    checkoutWeekly: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=4539&paymenttype=debitsuccess',
    checkoutAfterpay: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=4539&paymenttype=afterpay',
    tagCapsules: ['Animal Care', 'Dog Grooming', 'CPD Endorsed'],
    heroImage: '/oca-assets/dog-hero.jpg'
  },
  'criminology': {
    name: 'Criminology & Psychology Course Bundle',
    ...
    checkoutAfterpay: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=9410&paymenttype=afterpay',
    tagCapsules: ['Criminology', 'Criminal Profiling', 'CPD Endorsed'],
    heroImage: '/oca-assets/criminology-hero-v2.jpg'
  },
  'criminology-leads': {
    name: 'Criminology & Psychology Course Bundle',
    infoPackUrl: 'https://ocaedu.au/courseguide-criminology',
  ...
  'social-media': {
    name: 'Social Media Masterclass & Mentorship Bundle',
    infoPackUrl: 'https://ocaedu.au/courseguide-social',
    upfrontPrice: '$1,699',
    fullUpfrontPrice: '$2,355',
    weeklyPrice: '$15',
    weeklyPaymentCount: 157,
    afterpayPrice: '$424.75',
    checkoutUpfront: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=5381',
    checkoutWeekly: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=5381&paymenttype=debitsuccess',
    checkoutAfterpay: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=5381&paymenttype=afterpay',
    tagCapsules: ['Social Media', 'Marketing', 'CPD Endorsed'],
    heroImage: '/oca-assets/meta-mentor.png'
  },
  'makeup': {
  ...
  'mental-health': {
    ...
    infoPackUrl: 'https://ocaedu.au/courseguide-mhealth',
    upfrontPrice: '$1,499',
    fullUpfrontPrice: '$2,040',
    weeklyPrice: '$15',
    afterpayPrice: '$374.75',
    checkoutUpfront: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=10367',
    checkoutWeekly: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=10367&paymenttype=debitsuccess',
    checkoutAfterpay: 'https://www.onlinecoursesaustralia.edu.au/checkout?courseid=10367&paymenttype=afterpay',
