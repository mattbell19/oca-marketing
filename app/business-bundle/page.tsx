...
const TrustpilotSlider = () => {
  const reviews = [
    ...
    { name: "Hing Mui Chin", header: "Looking for the right course.....", text: "The course offers a highly comprehensive syllabus covering management and business...", stars: 4, date: "6 days ago" },
  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-white text-[#1d3b56] selection:bg-[#a6d5c7] selection:text-[#1d3b56]">
      ...
      <main id="top">
          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(420px,1.1fr)] lg:gap-10">
            <div className="min-w-0">
              <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
                ...
                <h1 className="max-w-2xl text-4xl font-black leading-[0.98] tracking-[-0.045em] text-[#1d3b56] sm:text-5xl md:text-6xl lg:text-7xl">
                  Maximise your potential & gain in-demand business skills
                </h1>
                ...
                <p className="mt-5 max-w-xl text-base font-semibold leading-relaxed text-[#1d3b56]/80 md:text-lg">
                  Whether you’re looking to launch your own business or secure a top management position, this comprehensive course bundle is designed for you.
                </p>
                <p className="mt-3 max-w-xl text-base font-semibold leading-relaxed text-[#1d3b56]/80 md:text-lg">
                  Master the core principles of business planning, management, marketing, and administration, while gaining the practical knowledge to succeed.
                </p>
              </motion.div>
            ...
            <div className="min-w-0">
              <div className="relative mx-auto max-w-[620px]">
                ...
                {/* Scroll Target Anchor for Lead Form */}
        ...
        {/* 3. Trustpilot Social Proof Carousel */}
        ...
        {/* 5. 30 Essential Topics Syllabus */}
          ...
          <div className="mx-auto max-w-6xl">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-xl text-sm font-semibold leading-relaxed text-gray-500 sm:text-base">
                This comprehensive short course bundle includes 9 courses covering 30 essential topics.
              </p>
            </div>
            ...
            <div className="mt-12 flex justify-center">
              <a href="#lead-form" className="inline-flex items-center gap-2 rounded-full bg-[#1d3b56] px-6 py-3.5 text-xs font-black uppercase tracking-[0.14em] text-white shadow-md transition hover:bg-[#f38669]">
        ...
        {/* 6. Course Credentials & Breakdown */}
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-10 space-y-4">
              {[
                {
                  id: 'topics',
                  label: '30 Essential Learning Topics',
                  content: 'Learn how to lead and manage people, support staff recruitment, manage meetings, budgets, and marketing. Delves deep into 30 key areas to ensure you are fully prepared.'
                },
                {
                  id: 'credentials',
