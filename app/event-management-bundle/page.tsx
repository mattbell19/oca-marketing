...
export default function EventManagementLandingPage() {
  ...
  const courseDetailsList = [
    ...
    },
    {
      ...
      desc: `Upfront Payment, Afterpay, Latitude Pay or a flexible Payment Plan (${offer.weeklyPrice} per week). Get more details in the course infopack.`
    }
  ]
  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-white text-[#1d3b56] selection:bg-[#a6d5c7] selection:text-[#1d3b56]">
      ...
      <main id="top">
        ...
        {/* 11. Authentic Trustpilot Showcase */}
        <TrustpilotShowcase courseName="Event Management" />
